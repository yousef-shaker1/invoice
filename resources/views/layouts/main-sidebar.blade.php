	...
	<div class="main-sidemenu">
		<div class="app-sidebar__user clearfix">
			<div class="dropdown user-pro-body">
				<div class="">
					<img alt="user-img" class="avatar avatar-xl brround" src="{{URL::asset('assets/img/faces/user_account_icon_145918.png')}}"><span class="avatar-status profile-status bg-green"></span>
				</div>
				<div class="user-info">
				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							@endcan
							@can("ارشيف الفواتير")
							<li><a class="slide-item" href="{{ route('invoice.archef_show') }}"> ارشيف الفواتير </a></li>
							@endcan
						</ul>
					</li>
					@endcan
