                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu tx-13">
                                                    ...
                                                    @endcan
                                                        ...
                                                        data-invoice_id="{{ $invoice->id }}" data-number="{{ $invoice->invoice_number }}"
            ...
            <div class="modal-content">
                ...
                <form action="{{ route('invoice.destroy', $x) }}" method="post">
                    ...
                    <div class="modal-body">
                        ...
                        <input class="form-control" name="number" id="number" type="number" value="" readonly>
                    </div>
...
@section('js')
   ...
   $('#modaldemo9').on('show.bs.modal', function(event) {
        ...
        var number = button.data('number') // تم تعديل هنا
        var modal = $(this)
