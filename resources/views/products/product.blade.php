                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            data-product_name="{{ $Product->product_name }}" data-pro_id="{{ $Product->id }}"
                                                ...
                                                data-description="{{ $Product->desciption }}" data-toggle="modal"
                                                data-target="#edit_Product">تعديل</button>
                                                @endcan
                                                
                                                @can("حذف منتج")
                                                <button class="btn btn-outline-danger btn-sm " data-pro_id="{{ $Product->id }}"
                                                    data-prodect_name="{{ $Product->product_name }}" data-toggle="modal"
        ...
        <div class="modal fade" id="edit_Product" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form action="{{ route('product.update', $i) }}" method="post">
                        @method('patch')
                        @csrf
                        <div class="modal-body">
                ...
                <div class="modal-content">
                    ...
                    <form action="{{ route('product.destroy', $i) }}" method="post">
                        ...
                        <div class="modal-body">
                            ...
                            <input class="form-control" name="prodect_name" id="prodect_name" type="text" vlaue="" readonly>
                        </div>
                        <div class="modal-footer">
...
$('#edit_Product').on('show.bs.modal', function(event) {
    ...
    var pro_id = button.data('pro_id') // هنا تم تصحيح الاسم من id إلى pro_id
