                    ...
                    <form action="{{ route('invoice.update', $invoices->id) }}" method="post" enctype="multipart/form-data"
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input class="form-control fc-datepicker" name="Due_date" value="{{ $invoices->Due_date }}" placeholder="YYYY-MM-DD"
                                    type="text" required>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <select value="{{ $invoices->Rate_VAT }}" name="Rate_VAT" id="Rate_VAT" class="form-control" onchange="myFunction()">
                                    <!--placeholder-->
