...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">الفاتورة</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/طباعة الفاتورة</span>
						</div>
					</div>
				</div>
				<!-- breadcrumb -->
								...
								<div class="card-body">
									<div class="invoice-header">
										...
										<div class="billed-from">
											...
											Tel No: 01101336383<br>
											Email: youssefshaker2cool@gmail.com</p>
										</div><!-- billed-from -->
									</div><!-- invoice-header -->
                  ...
                  <div class="table-responsive mg-t-40">
                    <table class="table table-invoice border text-md-nowrap mb-0">
                        ...
                        <tbody>
                            <tr>
                                <td>1</td>
                                <td class="tx-12">{{ $invoices->prodect }}</td>
