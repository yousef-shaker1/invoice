            ...
            <div class="nav nav-item  navbar-nav-right ml-auto">
                                ...
                                <div class="menu-header-content bg-primary text-right">
                                    <div class="d-flex">
                                        ...
                                        <span class="badge badge-pill badge-warning mr-auto my-auto float-left"><a
                                                href="{{ route('MarkAsRead_all') }}">قراءة الكل</a></span>
                                    </div>
                                ...
                                <div class="main-notification-list Notification-scroll">
                                        @foreach (Auth::user()->unreadNotifications as $not)
                                            <a class="d-flex p-3 border-bottom"
                                                href="{{ route('invoice.details', $not->data['id']) }}">
                                                <div class="notifyimg bg-pink">
                                                    <i class="la la-file-alt text-white"></i>
                                                </div>
                                                <div class="mr-3">
                                                    <h5 class="notification-label mb-1" >
                                                        {{ $not->data['title'] }} {{ $not->data['User'] }}
                                                    </h5>
                                                    <div class="notification-subtext">{{ $not->created_at }}</div>
                                                </div>
                ...
                <div class="dropdown main-profile-menu nav nav-item nav-link">
                    <a class="profile-user d-flex" href=""><img alt=""
                            src="{{ URL::asset('assets/img/faces/user_account_icon_145918.png') }}"></a>
                    <div class="dropdown-menu">
                        <div class="main-header-profile bg-primary p-3">
                            <div class="d-flex wd-100p">
                                <div class="main-img-user"><img alt=""
                                        src="{{ URL::asset('assets/img/faces/user_account_icon_145918.png') }}"
                                        class=""></div>
